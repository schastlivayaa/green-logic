...
export function createSlider() {
  ...
  const slidesData = [
    {
      title: 'Играй в приложении',
      text: 'Заводи виртуального питомца, развивай его через мини-игры и ежедневные задания.',
      imgSrc: robot1,
      imgAlt: 'Пример работы приложения',
    },
    {
      title: 'Сортируй отходы',
      text: 'Сдавай пластиковые крышки, батарейки, макулатуру. Сканируй QR-код в пункте приема — получай бонусы.',
      imgSrc: robot2,
      imgAlt: 'Пример работы приложения',
    },
    {
      title: 'Получай награды',
      text: 'Повышай уровень, открывай эксклюзивный контент и получай реальные призы от партнеров.',
      imgSrc: robot1,
      imgAlt: 'Пример работы приложения',
    },
  ];
